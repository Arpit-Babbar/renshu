...
{
    public:
      Linear_Convection_1d(double x_min, double x_max, double coefficient   //PDE Parameters
    ...
    private:
      ...
      void lax_wendroff(); //Gives solution at next time step
...
Linear_Convection_1d::Linear_Convection_1d(double x_min, double x_max, double coefficient     
...
int main()
{
    ...
    //make_grid
    Linear_Convection_1d solver(x_min,x_max,coefficient,initial_data, n_points,cfl);
    solver.run();
    return 0;
}
