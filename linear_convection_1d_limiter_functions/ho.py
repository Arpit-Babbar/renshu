...
IFO, IMMOD, IMC, IWENO5, IMP5, IVL, SOUP = 1, 2, 3, 4, 5, 6, 7
...
def minmod4(a,b,c,d):
    if a*b > 0.0 and b*c > 0.0 and c*d > 0.0 and d*a > 0.0:
...
def reconstruct(ujm2, ujm1, uj, ujp1, ujp2):
    ...
    elif scheme == SOUP: #Second order upwind
...
parser.add_argument('-scheme', choices=('FO','MMOD','MC','VL','WENO5','MP5', 'SOUP'),
                    help='Scheme', default='FO')
parser.add_argument('-Tf', type=float, help='Final time', default=1.0)
parser.add_argument('-ic', choices=('smooth','hat','mult','cts_sine'), help='Init cond', default='smooth')
...
elif args.ic == "cts_sine":
    xmin, xmax = -1.0, 1.0
    solve(args.N, args.cfl, args.scheme, args.Tf, xmin, xmax, cts_sine, nrk)